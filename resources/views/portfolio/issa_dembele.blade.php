...
<body>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        <img src="{{asset('img/issa_dembele_img.jpg')}}" alt="" class="img-fluid rounded-circle">
        <h1 class="text-light"><a href="index.html">DEMBELE INZA</a></h1>
        <p class="text-light text-center">Ingénieur marketing et communication, Bilingue</p>
      ...
      <nav id="navbar" class="nav-menu navbar mb-4 pb-4">
        <ul>
          ...
          <li><a href="{{route('cvs.show','issa_dembele')}}" class="nav-link scrollto mb-4"><i class="bx bx-circle"></i> <span>Voir le CV résumé</span></a></li>
        </ul>
      </nav><!-- .nav-menu -->
  ...
  <footer id="footer" class="card">
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Vali DIomandé</span></strong>
      </div>
      <div class="credits">
        ...
        Designed by <strong>BootstrapMade</strong>
      </div>
    </div>
  </footer><!-- End  Footer -->
    </div>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="hero-container" data-aos="fade-in">
      <h1>DEMBELE INZA</h1>
      <p>Je suis <span class="typed" data-typed-items="Communicateur, Marketeur, Freelancer, Bilinque"></span></p>
    </div>
  </section><!-- End Hero -->
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="section-title">
          <h2>À propos</h2>
          <p>
            Récemment diplômé au groupe ITA ingénierie SA, je suis à
        ...
        <div class="row">
          <div class="col-lg-4" data-aos="fade-right">
            <img src="{{asset('img/issa_dembele_img.jpg')}}" class="img-fluid" alt="">
          </div>
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            <h3>Ingénieur Marketing &amp; Communication.</h3>
            <p class="fst-italic">
              Certifé TESOL/TEFL. Capable de tenir parfaitement une discution en anglais et en français.
            </p>
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Adresse:</strong> <span>Abidjan, Yopougon</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>05 45 09 98 88/ 05 65 83 50 82 / 07 08 60 65 28</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>Inzouldem4@gmail.com</span></li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Permis de conduire:</strong> <span>A,B,C,D,E</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Niveau:</strong> <span>Master</span></li>
        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-6 d-md-flex align-items-md-stretch" data-aos="fade-up">
            <div class="count-box">
              ...
              <span>Bilingue</span>
              <p><strong>Anglais  - Français</strong> très bon niveau</p>
              <p><strong>TESOL/TEFL</strong> certification</p>
            </div>
          </div>
          ...
          <div class="col-md-6 d-md-flex align-items-md-stretch" data-aos="fade-up">
            <div class="count-box">
              ...
              <p><strong>Plus de pratique</strong> | une formation accés sur la pratique et l'interraction avec les personnes</p>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row skills-content">
          ...
          <div class="col-lg-6" data-aos="fade-up">
            ...
            <div class="progress">
              <span class="skill">Elaboration de strategie de communication et Marketing <i class="val">100%</i></span>
            ...
            <div class="progress">
              <span class="skill">Gestion de la clientèle <i class="val">100%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
            ...
            <div class="progress">
              <span class="skill">Management de la force de vente <i class="val">80%</i></span>
              <div class="progress-bar-wrap">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="progress">
              <span class="skill">Travailler sur des campagnes de publicité <i class="val">75%</i></span>
              <div class="progress-bar-wrap">
    ...
    <section id="resume" class="resume">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6" data-aos="fade-up">
            <h3 class="resume-title">Short</h3>
            <div class="resume-item pb-0">
              <h4>DEMBELE INZA</h4>
              <p><em>Récemment diplômé au groupe ITA ingénierie SA, je suis à
la recherche d'une première expériences pour consolider et
mettre en pratique mes connaissances théoriques. J'aime
travailler en équipe ,je suis polyvalent et je suis également
capable d'apprendre et d'appliquer rapidement de nouvelles choses.</em></p>
              <ul>
                <li>Bonne connaissance de outils informatique</li>
                <li>Marié</li>
                <li>Sens de la responsabilité</li>
              </ul>
            </div>

            <h3 class="resume-title">Éducation</h3>
            <div class="resume-item">
              <h4>Master Pro 2 option Marketing-Communication-Publicité</h4>
              <h5>Depuis décembre 2021</h5>
              <p><em>Groupe ITA ingénierie SA</em></p>
              <p>
                <ul>
            ...
            <div class="resume-item">
              <h4>Master pro 1 option Marketing-Communication-Publicité</h4>
              <h5>2020 - 2021</h5>
              <p><em>Groupe ITA ingénierie SA</em></p>
              <p>
                <ul>
            ...
            <div class="resume-item">
              <h4>Licence pro en Marketing-communication-publicité</h4>
              <h5>2019 - 2020</h5>
              <p><em>Groupe ITA ingénierie SA</em></p>
              <p>
                <ul>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="resume-item">
              ...
              <p><em>CDPA</em></p>
              <ul>
                <li>Gestion des opérations de caisses</li>
                <li>Préparation et suivi des versements bancaires</li>
                <li>Paiement de salaire aux travailleurs journaliers</li>
              </ul>
            </div>
            <div class="resume-item">
              <h4>Représentant commerciale</h4>
              <h5>Mars 2017 - Dec 2018</h5>
              <p><em>X-TIGI MOBILE</em></p>
              <ul>
          ...
          <div class=" d-flex align-items-stretch">
            <div class="info">
              ...
              <div class="email">
                ...
                <h4>Email:</h4>
                <p>inzouldem4@gmail.com</p>
              </div>

              <div class="phone">
                <i class="bi bi-phone"></i>
                <h4>Téléphone:</h4>
                <p>05 45 09 98 88 / 05 65 83 50 82</p>
              </div>

              <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d12097.433213460943!2d-74.0062269!3d40.7101282!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xb89d1fe6bc499443!2sDowntown+Conference+Center!5e0!3m2!1smk!2sbg!4v1539943755621" title="Location" style="border:0; width: 100%; height: 290px;" allowfullscreen></iframe>
            </div>
